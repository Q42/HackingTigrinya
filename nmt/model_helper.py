...
# Note: this is a slightly modified version of the original `create_infer_model` function.
# The original function is needed for training. This v2 version is needed for exporting the trained model.
# TODO: merge those 2 versions.
def create_infer_model_v2(model_creator, hparams, scope=None, extra_args=None):
  graph = tf.Graph()
  src_vocab_file = hparams.src_vocab_file
  tgt_vocab_file = hparams.tgt_vocab_file
